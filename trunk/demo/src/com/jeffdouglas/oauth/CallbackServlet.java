...
/**
 * The servlet that is called from Salesforce after the app is authorized. It stores the
 * access tokens in bigtable and caches the session info
 * 
 * @author Jeff Douglas
 */
...
public class CallbackServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      OAuthAccessor accessor = new OAuthAccessor(new OAuthConsumer(OauthSettings.URL_CALLBACK, OauthSettings.CONSUMER_KEY, OauthSettings.CONSUMER_SECRET, null));
      ...
      String response = OauthHelperUtils.getAccessToken(accessor, oauthVerifier, OauthSettings.URL_ACCESS_TOKEN);
      ...
      if (loginResponse.startsWith("<")) {
        OauthHelperUtils.XmlResponseHandler xmlHandler = OauthHelperUtils.parseResponse(loginResponse);
          ...
          // set the connection
          connection.cacheSessionProps(OauthSettings.URL_AUTH_ENDPOINT, serviceEndpoint, sessionId);
      }
